    ...
    <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg">
            <div class="card-body p-lg-5 p-0">
                ...
                <div class="row">
                    <div class="col-lg-6 d-none d-lg-block "><img src="./assets/img/avatar/amikom.png" width="100%" height="90%" alt="" srcset=""></div>
                    <div class="col-lg-6">
                        <div class="p-5">
                            <div class="text-center mb-4">
                                <h1 class="h4 text-gray-900">Aplikasi Rencana Pembelajaran Semester</h1>
