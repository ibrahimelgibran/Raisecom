...
<head>
    ...
    <title>Responsi - Aplikasi RPS</title>
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                <div class="sidebar-brand-icon">
                    <i><img src="./assets/img/avatar/amikom.png" alt="" width="35px" height="35px" style="margin-top:-5px"></i>
                </div>
                <div class="sidebar-brand-text mx-3">Aplikasi RPS</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Halaman RPS</h1>
